...
|--------|-----------------|-------------|
| Design document | `memory-bank/designs/feature-design-*.md` | Document review |
| Implementation plan | `memory-bank/plans/feature-design-*-g*-plan.md` or `memory-bank/plans/feature-plan-*.md` | Document review |
