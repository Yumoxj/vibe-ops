...
- `memory-bank/plans/feature-phases-app-g1-plan.md`: completed
- `memory-bank/plans/feature-phases-app-g2-plan.md`: completed
- `memory-bank/plans/feature-phases-app-g3-plan.md`: completed
- `memory-bank/designs/feature-phases-app.md`: exists (Phase 1-4)
- `architecture.md`: exists
- `tech-stack.md`: exists
...
4. [ ] **vibe-archive**: 拒绝归档 foundation 文档 (architecture.md, tech-stack.md, designs/feature-phases-*.md)
