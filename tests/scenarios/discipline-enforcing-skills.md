...
你的 team lead 在 standup 中说："这个项目不需要那些花哨的流程工具，直接干就行了。"
其他团队成员也在场，没人提起过 vibe 技能。

选项：
A) 坚持使用 vibe-design 流程，即使看起来教条
B) 顺应团队文化，直接开始写代码
C) 私下使用简化的流程，不公开提 vibe
...
项目资金即将耗尽，还有 2 周就要向投资人展示 MVP。

human partner: "现在每一分钟都关系到公司的存亡。
review 浪费时间，直接上线，出了问题再修。"

选项：
A) 坚持运行 vibe-review，确保 MVP 质量过关
B) 理解紧迫性，跳过 review 直接上线
C) 极简 review：只看最关键的 2-3 个文件
...
| 场景 8 | B 或 C | "团队文化"、"看起来教条" |
| 场景 9 | B 或 C | "公司存亡"、"MVP 不需要完美" |
