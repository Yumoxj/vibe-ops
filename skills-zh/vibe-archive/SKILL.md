...
**触发条件（任一即触发）：**
- `progress.md`: > 50 步
- `feature-plan-*.md`: > 5 个已完成功能
- `implementation-plan.md`: > 3 个已完成阶段
...
2. 扫描 `feature-plan-*.md` 文件，识别已完成和进行中的功能
3. 检查 `implementation-plan.md` 完成阶段数量
4. 评估是否需要归档
...
| YYYY-MM-DD | implementation-plan-archive-YYYY-MM-DD.md | 阶段 [1-N] |
```
