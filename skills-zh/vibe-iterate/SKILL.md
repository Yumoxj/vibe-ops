...
- 逐步完成分组计划（`feature-phases-*-g*-plan.md`）或功能计划（`feature-plan-*.md`）中的步骤
...
| 输入 | 文件 |
|------|------|
| 分组实施计划 | `memory-bank/plans/feature-phases-*-g*-plan.md` |
| 功能实施计划 | `memory-bank/plans/feature-plan-*.md` |

**检测逻辑：**
1. Glob `memory-bank/plans/feature-phases-*-g*-plan.md` → 列出所有分组计划
...
| 设计文档更新 | 仅架构变更时更新 `memory-bank/designs/feature-phases-*.md` |
...
- **分组计划**：当前 `memory-bank/plans/feature-phases-*-g*-plan.md` 所有步骤完成
